#-------------------------------------------------------------------------------------------------
# For é uma estrutura de repetição, for cria um loop que percorre entre um espaço, esse espaço é 
# determinado pelo programador, podendo ser o espaço entre 1 e 10, podendo ser um array, uma lista
# etc.  
#-------------------------------------------------------------------------------------------------
